...
<spring:url value="/resources/core/css/overview.css" var="coreCss" />
	...
	<div class="row container">
		<div class="col-2 col-m-2">
			<ul>
				...
				<li><a class="active" href="${pageContext.request.contextPath}/overview">Travel orders</a>
					<ul>
				...
				<tbody>
					<c:forEach var="travel" items="${travels}">
						<tr>
							...
							<td>${travel.ddep}</td>
							<td>${travel.status}</td>
							<td><a href="manage/${travel.travelid}" class="openOrder">View</a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
